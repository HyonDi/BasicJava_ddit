...
//		database.tb_bigCategory.size();
		...
		System.out.println();
		System.out.printf("> 대분류: %d번 [%s]을 선택하셨습니다.", iInputBig, database.tb_bigCategory.get(iInputBig));
		System.out.println();
		...
		case 0:
			...
			System.out.println();
			System.out.println();
			System.out.printf("> 중분류: %d번 [%s]을 선택하셨습니다.", iMidCode, database.tb_00_midCategory.get(iMidCode));
			System.out.println();
			break;
		...
		case 1:
			...
			System.out.println();
			System.out.println();
			System.out.printf("> 중분류: %d번 [%s]을 선택하셨습니다.", iMidCode, database.tb_01_midCategory.get(iMidCode));
			System.out.println();
			break;
		...
		case 2:
			...
			System.out.println();
			System.out.println();
			System.out.printf("> 중분류: %d번 [%s]을 선택하셨습니다.", iMidCode, database.tb_02_midCategory.get(iMidCode));
			System.out.println();
			break;
		case 3:
			...
			System.out.println();
			System.out.println();
			System.out.printf("> 중분류: %d번 [%s]을 선택하셨습니다.", iMidCode, database.tb_03_midCategory.get(iMidCode));
			System.out.println();
			break;
		case 4:
			...
			System.out.println();
			System.out.println();
			System.out.printf("> 중분류: %d번 [%s]을 선택하셨습니다.", iMidCode, database.tb_04_midCategory.get(iMidCode));
			System.out.println();
			break;
		case 5:
			...
			System.out.println();
			System.out.println();
			System.out.printf("> 중분류: %d번 [%s]을 선택하셨습니다.", iMidCode, database.tb_05_midCategory.get(iMidCode));
			System.out.println();
			break;
		case 6:
			...
			System.out.println();
			System.out.println();
			System.out.printf("> 중분류: %d번 [%s]을 선택하셨습니다.", iMidCode, database.tb_06_midCategory.get(iMidCode));
			System.out.println();
			break;
		case 7:
			...
			System.out.println();
			System.out.println();
			System.out.printf("> 중분류: %d번 [%s]을 선택하셨습니다.", iMidCode, database.tb_07_midCategory.get(iMidCode));
			System.out.println();
			break;
		case 8:
			...
			System.out.println();
			System.out.println();
			System.out.printf("> 중분류: %d번 [%s]을 선택하셨습니다.", iMidCode, database.tb_08_midCategory.get(iMidCode));
			System.out.println();
			break;
		case 9:
			...
			System.out.println();
			System.out.println();
			System.out.printf("> 중분류: %d번 [%s]을 선택하셨습니다.", iMidCode, database.tb_09_midCategory.get(iMidCode));
			System.out.println();
			break;
		case 10:
			...
			System.out.println();
			System.out.println();
			System.out.printf("> 중분류: %d번 [%s]을 선택하셨습니다.", iMidCode, database.tb_10_midCategory.get(iMidCode));
			System.out.println();
			break;
		case 11:
			...
			System.out.println();
			System.out.println();
			System.out.printf("> 중분류: %d번 [%s]을 선택하셨습니다.", iMidCode, database.tb_11_midCategory.get(iMidCode));
			System.out.println();
			break;
		default:
			break;
...
//		category.setProductId(productId);
		...
		category.setProductQuantity(Quantity);
		//null 1231
	...
	public void printCategoryList() {
		...
		for(int i = categoryList.size() - 1; 0 <= i; i--){
			...
			System.out.println( /*(i + 1)":"*/ "[판매 상품 번호:" + category.getCategoryId() + "]\n" + //"\t|" +category.getBigCode() + "|" + category.getMidCode() + "|" + category.getSmallCode() + 
					"카테고리 판매자 아이디 : " +  category.getUserId() + "\n" + 
					"상품 이름 : " + category.getProductName() + "\n" +
					"상품 가격 : " + category.getProductPrice() + "\n" + 
					"상품 설명 : " + category.getProductExplain() + "\n" +
					"등록 날짜 : " + category.getProductRegDate() +"\n" +
					"상품 수량 : " + category.getProductQuantity()); 
		}
		System.out.println("------------------------------");		
	}
...
//			System.out.println((strInput.equalsIgnoreCase(category.getProductName())));

			//test
//			if(category.getProductName().indexOf(strInput) != -1)

			if(strInput.equalsIgnoreCase(category.getProductName()))
			{
...
//		return s;
	...
	public String printProductName(int productId) {
		...
		CategoryVO categoryObj = categoryDao.selectCategory("ID", productId);
		
		return categoryObj.getProductName();
